...
type SortKey = 'ddd' | 'volume' | 'fechamentos' | 'conversao' | 'ticketMedio';
...
export function DDDPage() {
  ...
  const handleSort = (key: SortKey) => {
    if (sortKey === key) {
      ...
      setSortKey(key);
      setSortAsc(key === 'ddd'); // DDD sort ascending by default
    }
  };
        ...
        <table className="w-full">
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan={6} className="border-t border-glass-border px-4 py-8 text-center text-muted text-body-md">
